...
do_install:append () {
	...
	install -m 0755  ${WORKDIR}/git/pcba_test/audio_qc.sh ${D}/iei_dqv_tool/pcba_test/
	install -m 0755  ${WORKDIR}/git/pcba_test/bt_qc.sh ${D}/iei_dqv_tool/pcba_test/
	install -m 0755  ${WORKDIR}/git/pcba_test/camera_qc.sh ${D}/iei_dqv_tool/pcba_test/
	...
	install -m 0755  ${WORKDIR}/git/pcba_test/m2_wifi_qc.sh ${D}/iei_dqv_tool/pcba_test/
